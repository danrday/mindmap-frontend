...
import {
  ...
  editValue
} from "../../redux/actions/categoryEdit";
  ...
  render() {
    return (
      <div>
        ...
        <select
          onChange={e =>
            this.props.changeSelectedCategory({
              categories: this.props.categories,
              value: e.target.value
            })
          }
          value={this.props.categoryEdit.category || "none"}
        >
        ...
        <input
          ...
          onChange={event =>
            this.props.editValue({ key: "radius", value: event.target.value })
          }
        />
        <br />
        <input
        ...
        <input
          ...
          onChange={event =>
            this.props.editValue({ key: "fontSize", value: event.target.value })
          }
        />
      </div>
    );
